...
var removeGridItem = function(itemId){
	var children = $.fgScrollView.Children;
	for(var i=0; i<children.length; i++){
		var currentChild = children[i];
		if(currentChild.Id == itemId){
			Ti.API.info('Removing view from grid');
			$.fgScrollView.remove(currentChild);
			break;
		}
	} 
};
...
exports.removeGridItem = removeGridItem;
